...
procesar_registro();   // Procesa registro si envían formulario
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="Formulario de registro para nuevo usuario" />
    <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" href="assets/fonts/fontawesome-all.min.css" />
    <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700&display=swap" rel="stylesheet" />
    <link href="https://fonts.googleapis.com/css?family=Noto+Serif+Dogra&display=swap" rel="stylesheet" />
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-6 col-xl-6">
                        <div class="card mb-5 mx-auto">
                            <?php
                                echo mostrar_mensaje_registro_extendido();
                            ?>
                            <div class="card-body col-md-8 mx-auto align-items-center">
                                ...
                                <form class="text-center" method="POST" id="registrar_usuario" novalidate>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control item" type="text" name="apellido" id="apellido" placeholder="Apellido/s" required minlength="2" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="correo" class="form-label" style="font-size: 20px;">Ingresa tu correo electrónico</label>
                                        <input class="form-control item" type="email" name="correo" id="correo" placeholder="ejemplo@gmail.com" required minlength="4" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control item" type="password" name="confirmar_clave" id="confirmar_clave" placeholder="********" required minlength="8" />
